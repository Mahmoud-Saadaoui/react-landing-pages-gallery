...
const EarlyAccess = () => {
  ...
  return (
    <section id="early-access" className="relative px-6 dark:bg-darkBlue2 md:px-0">
      <div className="bg-gray-200 dark:bg-darkBlue1 relative -top-40 mx-auto max-w-4xl space-y-6 rounded-lg p-10 px-6 text-center md:px-16">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-accentCyan w-full rounded-full p-3 px-6 hover:scale-95 md:w-56"
          >
