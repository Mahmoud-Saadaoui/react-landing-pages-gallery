const Video = () => (
  <div className="relative before:absolute before:inset-0 before:bg-[rgba(0,0,0,.4)]">
    ...
    <div className="absolute top-1/2 w-full -translate-y-1/2 bg-[rgba(15,116,143,.7)] p-[50px] text-center text-white">
      <h2 className="mb-[30px] font-normal uppercase">Super Awesome Video Here</h2>
